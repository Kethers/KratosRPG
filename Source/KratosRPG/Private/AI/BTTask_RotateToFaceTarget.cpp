...
FString UBTTask_RotateToFaceTarget::GetStaticDescription() const
{
	...
	return FString::Printf(TEXT("Smoothly rotate to face %s Key until the angle precision %s"), *KeyDescription, *FString::SanitizeFloat(AngelPrecision));
}
...
bool UBTTask_RotateToFaceTarget::HasReachedAnglePrecision(APawn* QueryPawn, AActor* TargetActor) const
{
	...
	return AngleDiff <= AngelPrecision;
}
